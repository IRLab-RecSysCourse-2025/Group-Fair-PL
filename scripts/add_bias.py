...
if args.ispca:
    input_folder = args.data_dir + "pca" + args.dataset + "/"
    output_folder = args.data_dir + "pca" + args.dataset + "biased_0_" + str(args.bias) + "/"
else:
    input_folder = args.data_dir + args.dataset + "/"
    output_folder = args.data_dir + args.dataset + "biased_0_" + str(args.bias) + "/"
